...
<div class="card p-4">
    ...
    <div class="modal fade" id="basicModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            ...
            <form action="core.php?aksi=<?=encryptData('tambahuser','aksi')?>" method="POST">
    ...
    <table class="table datatable">
        ...
        <tbody>
            ...
            <td><?=$user['nama']?></td>
            <td><?=$user['email']?></td>
            <td><a class="btn btn-danger btn-sm" href="core.php?aksi=<?=encryptData('hapususer','aksi')?>&token=<?=encryptData($user['id'],'id_user')?>"><span class="bi bi-trash"></span></a></td>
            </tr>
            <?php }?>
        </tbody>
    </table>
